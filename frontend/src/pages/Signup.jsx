    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.brand}>
          <img src="/logo.png" alt="Profilr Logo" style={{ width: '40px', height: '40px', objectFit: 'contain' }} />
        ...
        <form onSubmit={handleSignup} style={styles.form}>
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={styles.inputWrap}>
              <span style={styles.inputIcon}><i className="fa-solid fa-user" style={{color: '#64748b', fontSize: '16px'}}></i></span>
              <input
                type="text"
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={styles.inputWrap}>
              <span style={styles.inputIcon}><i className="fa-solid fa-envelope" style={{color: '#64748b', fontSize: '16px'}}></i></span>
              <input
                type="email"
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={styles.inputWrap}>
              <span style={styles.inputIcon}><i className="fa-solid fa-lock" style={{color: '#64748b', fontSize: '16px'}}></i></span>
              <input
                type="password"
